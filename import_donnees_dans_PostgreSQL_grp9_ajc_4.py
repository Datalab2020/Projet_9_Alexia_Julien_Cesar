        ...
        while nom_result >= 100:        # cette boucle while permet rechercher tous les résultats en les retournant par groupes de 100
            ...
            try:                                    # teste s'il y a une erreur
                ...
                for resultats in resp_bucle:
                    ...
                    cur.execute("""INSERT INTO public."projet_Job_IO_ajc_3" VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, 
                            %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s) ON CONFLICT (id) DO UPDATE SET (intitule, description, dateCreation, dateActualisation, lieuTravail_libelle, 
                                Insee_departement, Département, Insee_region, Région, lieuTravail_latitude, lieuTravail_longitude, lieuTravail_codePostal, 
                                romeCode, romeLibelle, appellationlibelle, entreprise_nom, typeContrat, typeContratLibelle, natureContrat, experienceExige, 
                                experienceLibelle, salaire_libelle, SalaireAnnuel1, SalaireAnnuel2, SalaireMensuel1, SalaireMensuel2, 
                                SalaireHoraire1, SalaireHoraire2, dureeTravailLibelleConverti, alternance, nombrePostes, accessibleTH, 
                                origineOffre_origine, origineOffre_urlOrigine, dateLastSeen) = (EXCLUDED.intitule, EXCLUDED.description, EXCLUDED.dateCreation, EXCLUDED.dateActualisation, EXCLUDED.lieuTravail_libelle, 
                                EXCLUDED.Insee_departement, EXCLUDED.Département, EXCLUDED.Insee_region, EXCLUDED.Région, EXCLUDED.lieuTravail_latitude, EXCLUDED.lieuTravail_longitude, EXCLUDED.lieuTravail_codePostal, 
                                EXCLUDED.romeCode, EXCLUDED.romeLibelle, EXCLUDED.appellationlibelle, EXCLUDED.entreprise_nom, EXCLUDED.typeContrat, EXCLUDED.typeContratLibelle, EXCLUDED.natureContrat, EXCLUDED.experienceExige, 
                                EXCLUDED.experienceLibelle, EXCLUDED.salaire_libelle, EXCLUDED.SalaireAnnuel1, EXCLUDED.SalaireAnnuel2, EXCLUDED.SalaireMensuel1, EXCLUDED.SalaireMensuel2, 
                                EXCLUDED.SalaireHoraire1, EXCLUDED.SalaireHoraire2, EXCLUDED.dureeTravailLibelleConverti, EXCLUDED.alternance, EXCLUDED.nombrePostes, EXCLUDED.accessibleTH, 
                                EXCLUDED.origineOffre_origine, EXCLUDED.origineOffre_urlOrigine, EXCLUDED.dateLastSeen);""",    
                    (resultats['id'], 
                     resultats['intitule'], 
                     ...
                     resultats['origineOffre']['origine'],
                     resultats['origineOffre']['urlOrigine'],
                     datetime.now())) # INSERT avec paramètres
